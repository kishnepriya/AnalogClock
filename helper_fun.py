...
def get_ticks():
    ...
    for i in range(0, 360, 6):
        ...
        x_coor = int(CENTER[0] + RADIUS * math.cos(i * math.pi / 180))
        y_coor = int(CENTER[1] + RADIUS * math.sin(i * math.pi / 180))
        
        hours_init.append((x_coor, y_coor))
    
    for i in range(0, 360, 6):

        x_coor = int(CENTER[0] + (RADIUS-20) * math.cos(i * math.pi / 180))
        y_coor = int(CENTER[1] + (RADIUS-20) * math.sin(i * math.pi / 180))
        
        hours_dest.append((x_coor, y_coor))
